...
function Read() {
    ...
    function setDataToStorage(id, firstname, lastname, registrationNo, email, course){
                            ...
                            apiData.filter((el) => {
                                if (el === "") {
                                  ...
                                  return (
                                    ...
                                    el.RegistrationNo.toLowerCase().includes(inputText) ||
                                    el.Email.toLowerCase().includes(inputText) ||
                                    el.Course.toLowerCase().includes(inputText)
                                        ...
                                        <tr key={item.id}>
                                            ...
                                            <div class="btn-group" role="group" aria-label="First group">
                                                <Link to='/students/edit'>
                                                    ...
                                                    onClick={() => setDataToStorage(item.studentId, item.FirstName, item.LastName, item.RegistrationNo, item.Email, item.Course)}>
                                                        <i className="fas fa-edit fa-sm"></i>
                                                    </button>
                                                </Link>    
                                                <button type="button" 
                                                class="btn btn-danger"
                                                onClick={() => { if (window.confirm('Are You Sure To Delete Data ??')) { handleDelete(item.studentId) } }}>
